<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/ad.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="KaosRentalSystem.Views.Admin.Home" %>
...
<body>
  ...
  <div class="container">
    ...
    <p class="lead">You can add,delete,update from other pages on navbar.
    </p>
          <p class="lead">Also you can see the features of cars on this page.
    </p>
  </div>
</div>
